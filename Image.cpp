...
void Image::AddPixel(int x, int y, const Pixel &pix) {
    data[width * (height - y) + x].r = data[width * (height - y) + x].r * (1 - pix.a/255) + pix.r * pix.a/255;
    data[width * (height - y) + x].g = data[width * (height - y) + x].g * (1 - pix.a/255) + pix.g * pix.a/255;
    data[width * (height - y) + x].b = data[width * (height - y) + x].b * (1 - pix.a/255) + pix.b * pix.a/255;
}
